...
final class Database {
    ...
    public function getFeedContent($feed_id){
        $query = $this->link->query(
    ...
    public function setFeedContent($feed_id, $content, $content_type){
        $this->link->query(
            " UPDATE " . DB_DATABASE . ".feeds " .
            " SET content='".$this->link->escape($content)."'" .
            " , `content-type`='".$this->link->escape($content_type)."'" .
            " WHERE feed_id = " . (int)$feed_id
        );
